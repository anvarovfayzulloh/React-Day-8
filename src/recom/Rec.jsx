...
const Rec = () => {
    return (
        <section className='popular pt-[32px]'>
                ...
                <div className="popular__wrapper">
                    ...
                    <div className='popular__cars grid grid-cols-4 gap-[32px]' >
                        ...
                        <div className='popular__car bg-[#FFFFFF] p-[24px] rounded-xl text-center' >
                            ...
                            <div className='flex justify-center' >
                                <img className='py-[68px]' src={car5} alt="" />
                            </div>
                            <div className='flex align-center gap-[16px]' >
                                <p className='gasoline flex  align-center gap-[6px] font-jakarta font-medium text-[#90A3BF]' >
                                    <img src={gasolines} alt="" />
                    ...
                    <div className='w-full flex items-center justify-center py-[64px] relative' >
                    <button className='font-jakarta font-semibold font-lg text-white bg-[#3563E9] rounded-md py-[10px] px-[20px]' >Show more car</button>
                    <p className='text-[#90A3BF] font-jakarta font-medium text-lg  absolute right-0' >
                    120 Car
                    </p>
                    </div>
                </div>
